    ...
    public class CDFReader
    {
        ...
        public CDFReader(string cdfFilePath)
        {
            ...
            if (Path.GetExtension(cdfFilePath) == ".cdf" && File.Exists(cdfFilePath))
            {
                ...
                _cdfFile = new CDF_File(_cdfFilePath);
                Attributes = _cdfFile.Attributes;
                Variables = _cdfFile.Variables;
            }
            else
            {
        ...
        {
            if (Path.GetExtension(_cdfFilePath) != ".cdf" || !File.Exists(_cdfFilePath))
