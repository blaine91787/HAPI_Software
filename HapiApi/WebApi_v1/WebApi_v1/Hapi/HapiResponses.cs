...
namespace WebApi_v1.Hapi
{
    public class HapiResponse
    {
        ...
        internal class Info : ResponseContent
        {
        ...
        internal class Catalog : ResponseContent
        {
            private List<Tuple<string, string>> HapiCatalog { get; set; }
            ...
            public override string GetResponse()
            {
                ...
                foreach (var tuple in HapiCatalog)
                {
                    sb.Append(
                        String.Format(
                            "\t\t{{ \"id\" : \"{0}\", \"title\" : \"{1}\" }},\n",
